        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          <div className="bg-brand-cream/30 p-8 border border-brand-charcoal/5 space-y-4">
            ...
            <p className="text-xs text-brand-muted leading-relaxed font-light">
              "Tôi đặt in áo thun 260GSM phôi thô bên studio PRINTEE cho đợt mở bán bộ sưu tập xuân hè. Nhận hàng thực tế màng PET bám siêu chắc, giặt máy không nứt vỡ hay sần sùi chút nào. Chắc chắn gắn bó lâu dài!"
            </p>
